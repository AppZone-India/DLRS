...
public class LinphonePreferenceManager
{
	...
	{
		return Engine.getContext().getString(key);
	}

	public boolean useSoftvolume()
	{
		return Engine.getPref().getBoolean(getString(R.string.pref_audio_soft_volume_key), false);
	}

	public boolean useAudioRoutingAPIHack()
	{
		return Engine.getPref().getBoolean(getString(R.string.pref_audio_hacks_use_routing_api_key), false);
	}

	public boolean useGalaxySHack()
	{
		return Engine.getPref().getBoolean(getString(R.string.pref_audio_hacks_use_galaxys_hack_key), false);
	}

	public int useSpecificAudioModeHack()
	{
		return Integer.parseInt(Engine.getPref().getString(getString(R.string.pref_audio_use_specific_mode_key), "0"));
	}
