...
*/
import static com.sim2dial.dialer.R.string.ec_calibrating;
import static com.sim2dial.dialer.R.string.pref_echo_cancellation_key;
import static com.sim2dial.dialer.R.string.pref_echo_canceller_calibration_key;
import static com.sim2dial.dialer.R.string.pref_media_encryption_key;
import static com.sim2dial.dialer.R.string.pref_transport_key;
...
import com.sim2dial.dialer.ui.LedPreference;
...
public class PreferencesFragment extends PreferencesListFragment implements EcCalibrationListener {
	...
	public void onCreate(Bundle bundle) {
		...
		//hidePreference(R.string.pref_network_key);
		//hidePreference(R.string.pref_advanced_key);
		...
		//hidePreference(R.string.pref_echo_cancellation_key);
		//hidePreference(R.string.pref_echo_canceller_calibration_key);
		//hidePreference(R.string.pref_codecs_key);
		//hidePreference(R.string.pref_call_key);
